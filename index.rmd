...
Now we will add the [data set on gun laws](https://www.statefirearmlaws.org/table.html) and the [census dataset](https://www.census.gov/data/datasets/2017/demo/popest/state-total.html). The government wasn't kind enough to provide us with a CSV, so we will have to do a slightly different proceidure for the .xlsx file they do provide. 
...
You will note that the datafram for pops_full has a lot of junk in it. If you open it and in Excell and compare it to the 
